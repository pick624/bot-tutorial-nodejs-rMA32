...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexCryNeema=/^\/cry neema/; botRegexLuck = /^\/luck/; botRegexFumble = /^\/fumble/; botRegexL = /^\/L/;  botRegexCryingg = /^\/cryy/;botRegexBye = /^\/bye/; botRegexMad = /^\/umad/; botRegexJoe = /^\/cry joe/; botRegexTrade = /^\/Trades/; botRegexCheese = /^\/cheese/
